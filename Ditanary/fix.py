                ...
                if isCompleted {
                    ...
                    ScrollView {
                        VStack(spacing: 30) {
                            ...
                            if !pronunciationManager.transcribedText.isEmpty {
                                Text("Bạn đọc: " + pronunciationManager.transcribedText)
                                    .font(.title3)
                                ...
                                VStack(spacing: 15) {
                                    ...
                                    if score.finalScore >= 75 {
                                        ...
                                        Button("Thử lại") {
                                            ...
                                            pronunciationManager.transcribedText = ""
                                        }
                                        .buttonStyle(.borderedProminent)
                                        .tint(.orange)
                                    }
...
class PronunciationManager: ObservableObject {
    ...
    func calculateSimilarity(target: String, input: String) -> PronunciationScore {
        ...
        // 1. Sequence Match Score (Levenshtein Distance)
        ...
        // 2. Pronunciation Confidence Score (from Apple AI)
        ...
        // Final Score: Penalty for wrong words + Penalty for bad pronunciation
